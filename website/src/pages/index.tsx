...
app.<span class="k-green">MapWarpDashboard</span>(<span class="k-yellow">"/warp"</span>); <span class="k-dim">// dashboard at /warp</span>`;
...
<span class="k-dim">$</span> dotnet add package Moberg.Warp.Dashboard
