...
/// </summary>
public static class WarpUIEndpointConventions
{
    /// <summary>
    ...
    /// </remarks>
    public static WarpUIEndpointConventionBuilder RequireWarpDashboardLogin(this WarpUIEndpointConventionBuilder builder)
    {
    ...
    /// </summary>
    public static WarpUIEndpointConventionBuilder RequireLocalRequests(this WarpUIEndpointConventionBuilder builder)
    {
        ArgumentNullException.ThrowIfNull(builder);
