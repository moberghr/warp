...
/// </summary>
/// <remarks>
/// These are real endpoints rather than middleware so that <c>MapWarpDashboard(...).RequireAuthorization(...)</c>
...
{
    private const string EmbeddedFileNamespace = "Warp.Dashboard.dist";
    private static readonly FileExtensionContentTypeProvider ContentTypes = new();

    internal static IEndpointConventionBuilder MapWarpSpa(this IEndpointRouteBuilder app, WarpDashboardOptions options, List<IWarpDashboardExtension> extensions, WarpDashboardGate gate)
    {
    ...
    private static async Task<IResult> Serve(HttpContext context, WarpDashboardOptions options, WarpSpaAssets assets, bool hasLogin)
    {
    ...
    private static async Task<string> RenderIndexHtml(WarpDashboardOptions options, bool hasLogin, CancellationToken cancellationToken)
    {
        ...
        var appSettingsString =
            ...
            + $" window.warpBrandName = {JsonValue(options.BrandName)};"
    ...
    private sealed class WarpSpaAssets
    {
        ...
        public WarpSpaAssets(string routePrefix, List<IWarpDashboardExtension> extensions)
        {
